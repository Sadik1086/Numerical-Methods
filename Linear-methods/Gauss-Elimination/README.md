...
The augmented matrix is transformed into upper triangular form by eliminating the elements below the main diagonal. The solution is then obtained using backward substitution.
